...
graph TD
    ...
    subgraph LO_PTR ["低阶通道层 (G.707 §8.2)"]
        TU3_PTR1["TU-3 指针解释 #1<br/>H1/H2 (0-764)<br/>V3负调整"]:::lo
        TU3_PTR2["TU-3 指针解释 #2<br/>H1/H2 (0-764)<br/>V3负调整"]:::lo
        TU3_PTR3["TU-3 指针解释 #3<br/>H1/H2 (0-764)<br/>V3负调整"]:::lo
    end
...
graph TD
    ...
    subgraph TU3_GEN ["低阶通道层 (G.707 §8.2)"]
        TU3_PTR1["TU-3 指针生成 #1<br/>H1/H2 (0-764)<br/>V3调整字节"]:::lo
        TU3_PTR2["TU-3 指针生成 #2<br/>H1/H2 (0-764)<br/>V3调整字节"]:::lo
        TU3_PTR3["TU-3 指针生成 #3<br/>H1/H2 (0-764)<br/>V3调整字节"]:::lo
    end
